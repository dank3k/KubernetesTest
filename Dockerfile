...
# We're adding 'curl' and 'mbstring' here, which now have their system dependencies installed above.
RUN docker-php-ext-install -j$(nproc) pdo pdo_mysql opcache intl mbstring iconv curl
